...
## Namleh Telemetry Policy

The Namleh profile disables gstack telemetry. Do not run remote telemetry commands or send skill usage outside the active process.

## Plan Status Footer

Skills that run plan reviews include the EXIT PLAN MODE GATE blocking checklist at the end of the skill. Skills that don't run plan reviews typically don't operate in plan mode and have no review report to verify; this footer is a no-op for them. Writing the plan file is the one edit allowed in plan mode.`;
  }
