...
import namlehCodex from './namleh-codex';

/** All registered host configs. Add new hosts here. */
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain, namlehCodex];
...
export { claude, codex, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain, namlehCodex };
